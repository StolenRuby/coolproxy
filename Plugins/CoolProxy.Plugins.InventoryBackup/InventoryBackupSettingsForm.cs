...
namespace CoolProxy.Plugins.InventoryBackup
{
    public partial class InventoryBackupSettingsForm : Form
    {
        ...
        public InventoryBackupSettingsForm()
        {
            ...
            this.TopMost = InventoryBackupPlugin.Proxy.Settings.getBool("KeepCoolProxyOnTop");
            InventoryBackupPlugin.Proxy.Settings.getSetting("KeepCoolProxyOnTop").OnChanged += (x, y) => { this.TopMost = (bool)y.Value; };
        }
